...
public class GoogleSample {
	...
	public static void init() {
		...
		sample.get("mondego").add("http://sdcl.ics.uci.edu/2012/05/calico-for-the-mondego-group/");
		sample.get("mondego").add("http://mondego.ics.uci.edu/datasets/wikipedia-events/files/");
		sample.get("mondego").add("http://www.ics.uci.edu/~lopes/");
		...
		sample.get("machine learning").add("http://cml.ics.uci.edu/?page=events&subPage=aiml");
        ...
        sample.get("security").add("http://www.ics.uci.edu/~goodrich/teach/ics8/");
		...
		sample.get("student affairs").add("http://www.ics.uci.edu/about/annualreport/2005-06/sao.php");
		...
		sample.get("REST").add("http://www.ics.uci.edu/~fielding/pubs/dissertation/abstract.htm");
		...
		sample.get("computer games").add("http://www.ics.uci.edu/ugrad/degrees/");
		...
		sample.get("information retrieval").add("http://www.ics.uci.edu/~djp3/classes/2014_01_INF141/structure.html");
